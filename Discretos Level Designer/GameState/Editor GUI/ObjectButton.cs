...
namespace Discretos_Level_Designer
{
    ...
    public class ObjectButton
    {
        ...
        /// </summary>
        public ObjectButton UpButton;
        public ObjectButton DownButton;
        public ObjectButton RightButton;
        public ObjectButton LeftButton;
        ...
        public void Draw(SpriteBatch spriteBatch, bool isEdgeRounded = false, bool withRightReflect = false, Color colorRightReflect = default)
        {
            ...
            if (Texture != null)
            {
                ...
                if (outlineTex != null)
                {
                    ...
                    spriteBatch.Draw(outlineTex, new Rectangle((int)Pos.X, (int)Pos.Y, (int)(SourceImg.Width * Scale), (int)(SourceImg.Height * Scale)), new Color(60,60,60));
                }
        ...
        /// For selection with Keyboard or Manette.
        /// </summary>
        public void SetAroundButton(ObjectButton _upButton = null, ObjectButton _downButton = null, ObjectButton _rightButton = null, ObjectButton _leftButton = null)
        {
            UpButton = _upButton;
