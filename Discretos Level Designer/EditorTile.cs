...
namespace Discretos_Level_Designer
{
    public class EditorTile
    {
        ...
        public EditorTile[,] grid;

        public bool isInMovingBlock;


        public EditorTile(Vector2 Position, BlockID id, bool isSlope = false, bool isStatic = true, Vector2 add = default, bool isInMovingBlock = false)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            if (ID != BlockID.mechanical && ID != BlockID.platform_brick_break && ID != BlockID.start_pos)
            {
            ...
            if (ID == BlockID.start_pos)
                spriteBatch.Draw(Main.StartPosImg, new Vector2(Position.X, Position.Y), new Rectangle(0, 0, 16, 16), Color.White);
        ...
        public void InitImg(EditorTile[,] grid)
        {
            this.grid = grid;

            TileFrame = Rectangle.Empty;
